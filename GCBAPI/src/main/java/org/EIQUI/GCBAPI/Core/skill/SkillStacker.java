...
public class SkillStacker {
    ...
    private static final Map<Entity, ConcurrentHashMap<String, SkillStacker>> STACKERS = new ConcurrentHashMap<>();
    ...
    public static int getStack(Entity e,String skill){
        ConcurrentHashMap<String,SkillStacker> tempmap = getOrCreateStackMap(e);
    ...
    private static ConcurrentHashMap<String, SkillStacker> getOrCreateStackMap(Entity e) {
